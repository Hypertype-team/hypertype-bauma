...
const ImageShowcase = ({ frontImage, setFrontImage }: ImageShowcaseProps) => {
  return (
    <motion.div 
      ...
      className="relative h-[300px] sm:h-[400px] lg:h-[500px] select-none"
      style={{
        perspective: '2000px',
      }}
    >
        ...
        style={{
          ...
          transform: `
            ${frontImage === 'dashboard' 
              ? 'translateZ(50px) translateX(-15%) translateY(-15%) rotateY(-15deg)' 
              : 'translateZ(-150px) translateX(-35%) translateY(-25%) rotateY(-25deg)'}
          `,
      ...
      >
        <img
          ...
          className="w-full h-auto rounded-2xl shadow-2xl max-w-[600px] mx-auto"
          style={{ 
            maxWidth: "100%",
            transition: 'all 1.2s cubic-bezier(0.4, 0, 0.2, 1)',
